...
from choochoo import question_bank_path, question_bank_markdown_path, question_folder_path

class QuestionBank:
    """ A class for manipulating the question_bank.
	...
	def question_dict_as_markdown(self, f, question_dict):
		...
		f.write("## "+entry["title"]+string_to_anchor(entry["title"])+"\n")
...
def string_to_anchor(input_string):
